        ...
        http
            ...
            .authorizeHttpRequests {
                it
                    ...
                    .requestMatchers(HttpMethod.GET, "/api/property-definitions").hasAnyRole("READER", "EDITOR", "ADMIN")
                    .requestMatchers(HttpMethod.POST, "/api/property-definitions/**").hasRole("ADMIN")
                    .requestMatchers(HttpMethod.PATCH, "/api/property-definitions/**").hasRole("ADMIN")
                    .requestMatchers(HttpMethod.DELETE, "/api/property-definitions/**").hasRole("ADMIN")
                    .requestMatchers("/api/me/views/**").hasAnyRole("READER", "EDITOR", "ADMIN")
                    .requestMatchers(HttpMethod.POST, "/api/tasks/complete").hasAnyRole("EDITOR", "ADMIN")
                    .requestMatchers(HttpMethod.POST, "/api/captures/**").hasAnyRole("EDITOR", "ADMIN")
                    .requestMatchers(HttpMethod.GET, "/api/me/daily-notes/**").hasAnyRole("READER", "EDITOR", "ADMIN")
                    ...
                    .requestMatchers(HttpMethod.PATCH, "/api/pages/**").hasAnyRole("EDITOR", "ADMIN")
